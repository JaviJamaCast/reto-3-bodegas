...
@section('content')
    <div class="row d-flex justify-content-center align-items-center trabajaConNosotrosClass" "> <!-- Ajusta los 56px según la altura de tu navbar -->
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body cardClass">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control d-none" id="fileUpload" accept=".pdf,.doc,.docx"  required>
                                <label class="btn tertiary-killer mx-3" for="fileUpload">{{ __('trabajaConNosotros.upload') }}</label>
                                <span id="fileName"></span>
                            </div>

                            <button type="submit" class="btn tertiary-killer">{{__('trabajaConNosotros.formEnviar')}}</button>
                        </form>
                    </div>
                </div>
            </div>
