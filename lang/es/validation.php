...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje contienen los mensajes de error por defecto usados por
    ...
    */
    ...
    'missing_with_all' => 'El campo :attribute debe estar ausente cuando todos los :values estén presentes.',
    ...
    'present_with_all' => 'El campo :attribute debe estar presente cuando todos los :values estén presentes.',
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto hace rápido
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para intercambiar nuestro marcador de posición de atributo
    | con algo más amigable para el lector como "Dirección de Correo" en lugar
